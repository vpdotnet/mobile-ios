...
final class DecoratorProductsProviderTests: XCTestCase {
    ...
    func instantiateSut(productsProviderResult: ([Plan : InAppProduct]?, Error?), subscriptionInformationProviderResult: (VP_VPN_tvOS.AppStoreInformation?, Error?)) {
    ...
    func test_listPlanProducts_adds_default_products_to_productConfiguration_when_there_is_no_valid_appstoreInformation() {
        ...
        let appStoreInformation: VP_VPN_tvOS.AppStoreInformation? = nil
