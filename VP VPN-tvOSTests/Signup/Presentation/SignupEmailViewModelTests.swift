...
final class SignupEmailViewModelTests: XCTestCase {
    ...
    func instantiateSut(signupUseCaseResult: Result<VP_VPN_tvOS.UserAccount, Error>, onSuccessAction: @escaping ((VP_VPN_tvOS.UserAccount) -> Void)) {
    ...
    func test_signup_executes_onSuccessAction_when_signup_returns_an_userAccount_and_a_valid_email_is_provided() {
        ...
        let expectedUserAccount = VP_VPN_tvOS.UserAccount.makeStub()
