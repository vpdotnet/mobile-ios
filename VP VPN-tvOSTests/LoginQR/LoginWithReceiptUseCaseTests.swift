...
final class LoginWithReceiptUseCaseTests: XCTestCase {
    ...
    func instantiateSut(paymentProviderResult: Result<Data, Error>, loginProviderResult: Result<VP_VPN_tvOS.UserAccount, Error>) {
    ...
    func test_login_succeeds_when_paymentProvider_completes_with_receipt_and_loginprovider_completes_with_success() async throws {
        // GIVEN
        let receipt = Data()
        let user = VP_VPN_tvOS.UserAccount.makeStub()
