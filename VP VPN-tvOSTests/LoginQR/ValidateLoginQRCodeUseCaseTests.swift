...
final class ValidateLoginQRCodeUseCaseTests: XCTestCase {
    ...
    func instantiateSut(userResult: VPLibrary.UserAccount?, errorResult: Error?, validateLoginQRCodeResult: Result<String, LoginQRCodeError>) {
    ...
    func test_callAsFunction_succeeds_when_validateLoginQRCodeProvider_and_accountProvider_succeeds() async {
        // GIVEN
        let userAccount = VPLibrary.UserAccount(credentials: VPLibrary.Credentials(username: "", password: ""), info: nil)
