...
final class LoginQRViewModelTests: XCTestCase {
    ...
    func instantiateSut(generateLoginQRResult: Result<LoginQRCode, ClientError>, validateLoginQRError: ClientError?, loginWithReceiptResult: Result<VP_VPN_tvOS.UserAccount, Error> = .failure(LoginError.unauthorized), onSuccessAction: @escaping () -> Void, onNavigateAction: @escaping () -> Void) {
