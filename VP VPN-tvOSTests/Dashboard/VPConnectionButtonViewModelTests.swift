//
//  VPConnectionButtonViewModelTests.swift
//  VP VPN-tvOSTests
//
...
final class VPConnectionButtonViewModelTests: XCTestCase {
    ...
    var fixture: Fixture!
    var sut: VPConnectionButtonViewModel!
    ...
    private func instantiateSut() {
        sut = VPConnectionButtonViewModel(useCase: fixture.vpnConnectionUseCaseMock,
