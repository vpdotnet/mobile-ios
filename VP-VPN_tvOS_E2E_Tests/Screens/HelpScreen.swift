...
extension XCUIApplication{
    ...
    var privacyPolicyMessageString: String {getString(key: "help_menu.about_section.privacy_policy.description", comment: "This privacy policy ('Privacy Policy' or 'Policy') explains the privacy practices of VP.NET, Inc.,")}
