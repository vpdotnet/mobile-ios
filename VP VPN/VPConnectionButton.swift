...
private struct VPConnectionButtonSettings {
    ...
    static let endAngle: CGFloat = VPConnectionButtonSettings.startAngle + 2 * .pi
...
class VPConnectionButton: UIButton, Restylable {
    ...
    private func setupView() {
        ...
        self.layer.borderWidth = VPConnectionButtonSettings.outsideBorderWidth
        ...
        self.circlePathLayer.lineWidth = VPConnectionButtonSettings.animatedShapeWidth
    ...
    private func circleAnimationPath() -> UIBezierPath {
        ...
        return UIBezierPath(arcCenter: center,
                            ...
                            startAngle: VPConnectionButtonSettings.startAngle,
                            endAngle: VPConnectionButtonSettings.endAngle,
                            clockwise: true)
    }
    
    private func updateColors() {
        UIView.animate(withDuration: VPConnectionButtonSettings.udpateColorAnimationDuration) { [weak self] in
    ...
    func startButtonAnimation() {
        ...
        let duration: CFTimeInterval = CFTimeInterval(VPConnectionButtonSettings.shapeAnimationDuration)
        ...
        end.timingFunction = VPConnectionButtonSettings.timingFunction
        ...
        begin.timingFunction = VPConnectionButtonSettings.timingFunction
        ...
        opacity.timingFunction = VPConnectionButtonSettings.timingFunction
    ...
    func stopButtonAnimation() {
        ...
        if isAnimating {
            ...
            ending.toValue = 1
            ending.duration = VPConnectionButtonSettings.shapeEndAnimationDuration
    ...
    private func buttonBorderColor() -> CGColor {
        return Theme.current.palette.appearance == .dark ?
            VPConnectionButtonSettings.outsideBorderDarkColor :
            VPConnectionButtonSettings.outsideBorderLightColor
    }
    
    private func highlightedButtonBorderColor() -> CGColor {
        return Theme.current.palette.appearance == .dark ?
            VPConnectionButtonSettings.highlightedOutsideBorderDarkColor :
            VPConnectionButtonSettings.highlightedOutsideBorderLightColor
    }
