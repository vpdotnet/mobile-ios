...
class AccountObserver {
    ...
    func start() {
        ...
        nc.addObserver(self, selector: #selector(registerExpirationNotifications), name: .VPAccountDidLogin, object: nil)
        nc.addObserver(self, selector: #selector(registerExpirationNotifications), name: .VPAccountDidSignup, object: nil)
        nc.addObserver(self, selector: #selector(registerExpirationNotifications), name: .VPAccountDidRefresh, object: nil)
        nc.addObserver(self, selector: #selector(accountDidLogout), name: .VPAccountDidLogout, object: nil)
