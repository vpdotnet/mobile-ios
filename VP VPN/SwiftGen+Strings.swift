...
internal enum L10n {
  internal enum Localizable {
    internal enum About {
      /// VPN by VP.NET
      internal static let app = L10n.tr("Localizable", "about.app", fallback: "VPN by VP.NET")
    ...
    internal enum Account {
      ...
      internal enum Other {
        /// Get the VP.NET app for your other devices and use the above username and password to login and secure your connection.
        internal static let footer = L10n.tr("Localizable", "account.other.footer", fallback: "Get the VP.NET app for your other devices and use the above username and password to login and secure your connection.")
      }
    ...
    internal enum ContentBlocker {
      ...
      internal enum Body {
        ...
        /// To enable our Content Blocker for use with Safari please go to Settings > Safari, and under General touch Content Blockers toggle on VP VPN.
        internal static let subtitle = L10n.tr("Localizable", "content_blocker.body.subtitle", fallback: "To enable our Content Blocker for use with Safari please go to Settings > Safari, and under General touch Content Blockers toggle on VP VPN.")
      }
    }
    ...
    internal enum Gdpr {
      ...
      internal enum Collect {
        internal enum Data {
          ...
          /// 
          /// E-mail address is used to send subscription information, payment confirmations, customer correspondence, and VP.NET promotional offers only.
    ...
    internal enum HelpMenu {
      ...
      internal enum AboutSection {
        ...
        internal enum PrivacyPolicy {
          /// This privacy policy ('Privacy Policy' or 'Policy') explains the privacy practices of VP.NET, Inc., (collectively, 'We', 'Us', 'Data Controller', 'Company', or 'PIA') and applies to users ('User(s)' or 'You') of PIA's services, including, among other things, the VP VPN service ('Service') and PIA website at www.vp.net ('Website').
          internal static let description = L10n.tr("Localizable", "help_menu.about_section.privacy_policy.description", fallback: "This privacy policy ('Privacy Policy' or 'Policy') explains the privacy practices of VP.NET, Inc., (collectively, 'We', 'Us', 'Data Controller', 'Company', or 'PIA') and applies to users ('User(s)' or 'You') of PIA's services, including, among other things, the VP VPN service ('Service') and PIA website at www.vp.net ('Website').")
    ...
    internal enum Hotspothelper {
      internal enum Display {
        ...
        internal enum Protected {
          /// 🔒 VP VPN WiFi Protection Enabled - We got your back.
          internal static let name = L10n.tr("Localizable", "hotspothelper.display.protected.name", fallback: "🔒 VP VPN WiFi Protection Enabled - We got your back.")
        }
      }
    }
    internal enum Inapp {
    ...
    internal enum Rating {
      ...
      internal enum Enjoy {
        /// Are you enjoying VP VPN?
        internal static let question = L10n.tr("Localizable", "rating.enjoy.question", fallback: "Are you enjoying VP VPN?")
    ...
    internal enum Settings {
      ...
      internal enum ContentBlocker {
        /// To enable or disable Content Blocker go to Settings > Safari > Content Blockers and toggle VP VPN.
        internal static let footer = L10n.tr("Localizable", "settings.content_blocker.footer", fallback: "To enable or disable Content Blocker go to Settings > Safari > Content Blockers and toggle VP VPN.")
      ...
      internal enum Trusted {
        internal enum Networks {
          ...
          internal enum Sections {
            ...
            internal enum Trusted {
              internal enum Rule {
                /// Disconnect from VP VPN
                internal static let action = L10n.tr("Localizable", "settings.trusted.networks.sections.trusted.rule.action", fallback: "Disconnect from VP VPN")
    ...
    internal enum Siri {
      internal enum Shortcuts {
        ...
        internal enum Connect {
          /// Connect VP VPN
          internal static let title = L10n.tr("Localizable", "siri.shortcuts.connect.title", fallback: "Connect VP VPN")
          internal enum Row {
        ...
        internal enum Disconnect {
          /// Disconnect VP VPN
          internal static let title = L10n.tr("Localizable", "siri.shortcuts.disconnect.title", fallback: "Disconnect VP VPN")
          internal enum Row {
    ...
    internal enum TopNavigationBar {
      ...
      internal enum VpnItem {
        /// VP VPN
        internal static let title = L10n.tr("Localizable", "top_navigation_bar.vpn_item.title", fallback: "VP VPN")
      }
    }
    internal enum Tvos {
      internal enum Login {
        /// Enter your VP VPN account details
        internal static let title = L10n.tr("Localizable", "tvos.login.title", fallback: "Enter your VP VPN account details")
      ...
      internal enum Signup {
        ...
        /// Get VP.NET
        internal static let title = L10n.tr("Localizable", "tvos.signup.title", fallback: "Get VP.NET")
        ...
        internal enum TermsConditions {
          /// This Terms of Service Agreement ('Agreement') covers the scope of your use and access to the PIA VP.NET, Inc. ('PIA') website (“Site”) located at www.vp.net, virtual private networking ('VPN'), and PIA's services provided through the Site ('Service(s)'). By visiting the Site, purchasing a subscription, and/or using the Services, You ('You' or 'Subscriber') ('PIA' and 'Subscriber' collectively known as 'Parties') acknowledge that you have read the Agreement, fully understand the terms and agree to be bound by all of the terms of the Agreement.
    ...
    internal enum VpnPermission {
      ...
      internal enum Body {
        ...
        /// You’ll see a prompt for VP VPN and need to allow access to VPN configurations.
        /// To proceed tap on “%@”.
        internal static func subtitle(_ p1: Any) -> String {
          return L10n.tr("Localizable", "vpn_permission.body.subtitle", String(describing: p1), fallback: "You’ll see a prompt for VP VPN and need to allow access to VPN configurations.\nTo proceed tap on “%@”.")
        }
  ...
  internal enum Welcome {
    ...
    internal enum Gdpr {
      ...
      internal enum Usage {
        internal enum Data {
          /// E-mail address is used to send subscription information, payment confirmations, customer correspondence, and VP.NET promotional offers only.
          internal static let description = L10n.tr("Welcome", "gdpr.usage.data.description", fallback: "E-mail address is used to send subscription information, payment confirmations, customer correspondence, and VP.NET promotional offers only.")
    ...
    internal enum Purchase {
      ...
      internal enum Error {
        ...
        internal enum Connectivity {
          /// We are unable to reach VP.NET. This may due to poor internet or our service is blocked in your country.
          internal static let description = L10n.tr("Welcome", "purchase.error.connectivity.description", fallback: "We are unable to reach VP.NET. This may due to poor internet or our service is blocked in your country.")
          /// Connection Failure
    ...
    internal enum Upgrade {
      ...
      /// In order to use VP.NET, you’ll need to renew your subscription.
      internal static let title = L10n.tr("Welcome", "upgrade.title", fallback: "In order to use VP.NET, you’ll need to renew your subscription.")
      internal enum Renew {
        /// Renew now
