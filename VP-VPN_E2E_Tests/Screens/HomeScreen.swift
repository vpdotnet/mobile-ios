...
extension XCUIApplication {
    var dashboardMenuButton: XCUIElement {button(with: VPLibraryAccessibility.Id.Dashboard.menu)}
    ...
    var confirmationDialogButton: XCUIElement {button(with: VPLibraryAccessibility.Id.Dialog.destructive)}
