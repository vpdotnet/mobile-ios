...
internal struct VPConnectionView: View {
    
    internal let context: ActivityViewContext<VPConnectionAttributes>
    ...
    init(context: ActivityViewContext<VPConnectionAttributes>, showProtocol: Bool = false) {
