...
struct VPConnectionActivityWidget: Widget {
    let localizedRegionText = L10n.Localizable.Widget.LiveActivity.Region.title
    
    var body: some WidgetConfiguration {
        ActivityConfiguration(for: VPConnectionAttributes.self) { context in
            ...
            VStack {
                ...
                .padding(.bottom)
                VPConnectionView(context: context, showProtocol: true)
