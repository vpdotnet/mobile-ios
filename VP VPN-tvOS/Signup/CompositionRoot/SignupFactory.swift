...
class SignUpFactory {
    static func makeSignupQRView() -> SignupQRView {
        let url = URL(string: "https://apps.apple.com/us/app/vpn-by-vp-net/id955626407")!
    ...
    static func makePrivacySignupTermsView() -> SignupTermsView {
        SignupTermsView(url: URL(string: "https://www.vp.net/privacy-policy")!,
    ...
    static func makeTermsConditionsSignupTermsView() -> SignupTermsView {
        SignupTermsView(url: URL(string: "https://www.vp.net/terms-of-service")!,
