...
class DashboardFactory {
    ...
    static func makeVPConnectionButton() -> VPConnectionButton {
        return VPConnectionButton(
            viewModel: makeVPConnectionButtonViewModel()
        )
    }
...
extension DashboardFactory {
    private static func makeVPConnectionButtonViewModel() -> VPConnectionButtonViewModel {
        return VPConnectionButtonViewModel(useCase: VpnConnectionFactory.makeVpnConnectionUseCase, connectionStateMonitor: StateMonitorsFactory.makeConnectionStateMonitor)
    }
