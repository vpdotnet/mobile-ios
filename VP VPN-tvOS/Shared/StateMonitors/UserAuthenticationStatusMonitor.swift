...
class UserAuthenticationStatusMonitor: UserAuthenticationStatusMonitorType {
    ...
    private func addObservers() {
        notificationCenter.addObserver(self, selector: #selector(handleAccountDidLogin), name: .VPAccountDidLogin, object: nil)
        
        notificationCenter.addObserver(self, selector: #selector(handleAccountDidLogout), name: .VPAccountDidLogout, object: nil)
    }
